...
export const whatsappMessages = {
  es: {
    ...
    promo: "Hola, quiero info sobre la promo lanzamiento de Gs. 850.000 para mi negocio.",
  ...
  en: {
    ...
    promo: "Hi, I want information about the launch promo of Gs. 850.000 for my business.",
