...
export default function Proceso() {
    ...
    const pasos = [
        {
            numero: "01",
            titulo: mounted ? t('process.steps.consultation.title') : "Consulta Inicial",
            descripcion: mounted ? t('process.steps.consultation.desc') : "Reunión para entender tus necesidades, objetivos y visión del proyecto.",
            icon: (
            ...
            duracion: mounted ? t('process.steps.consultation.duration') : "1-4 días",
        },
        {
            numero: "02",
            titulo: mounted ? t('process.steps.proposal.title') : "Propuesta & Cotización",
            descripcion: mounted ? t('process.steps.proposal.desc') : "Presentamos un plan detallado con cronograma, entregables y presupuesto.",
            icon: (
                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                </svg>
            ),
            duracion: mounted ? t('process.steps.proposal.duration') : "2-3 días",
        },
        {
            numero: "03",
            titulo: mounted ? t('process.steps.design.title') : "Diseño UI/UX",
            descripcion: mounted ? t('process.steps.design.desc') : "Creamos prototipos interactivos y diseños visuales para tu aprobación.",
            icon: (
                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42" />
                </svg>
            ),
            duracion: mounted ? t('process.steps.design.duration') : "1-2 semanas",
        },
        {
            numero: "04",
            titulo: mounted ? t('process.steps.development.title') : "Desarrollo",
            descripcion: mounted ? t('process.steps.development.desc') : "Programación con las mejores prácticas, código limpio y arquitectura escalable.",
            icon: (
                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
                </svg>
            ),
            duracion: mounted ? t('process.steps.development.duration') : "2-6 semanas",
        },
        {
            numero: "05",
            titulo: mounted ? t('process.steps.quality.title') : "Testing & QA",
            descripcion: mounted ? t('process.steps.quality.desc') : "Pruebas exhaustivas en múltiples dispositivos y navegadores.",
            icon: (
                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            ...
            duracion: mounted ? t('process.steps.quality.duration') : "1 semana",
        },
        {
            numero: "06",
            titulo: mounted ? t('process.steps.launch.title') : "Lanzamiento",
            descripcion: mounted ? t('process.steps.launch.desc') : "Despliegue en producción con monitoreo y optimización continua.",
            icon: (
                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            ...
            duracion: mounted ? t('process.steps.launch.duration') : "1-2 días",
        },
    ];
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm font-bold uppercase tracking-[0.2em]" style={{ color: theme.accent }}>
                            {mounted ? t('process.badge') : "Nuestra Metodología"}
                        </span>
                    </motion.div>

                    <h2 className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 px-4" style={{ margin: '1rem 0' }}>
                        <span style={{ color: theme.text }}>{mounted ? t('process.titleStart') : "Proceso"} </span>
                        ...
                        <span style={{
                            ...
                            {mounted ? t('process.titleHighlight') : "Transparente"}
                        </span>
                    </h2>
                    ...
                    <div className="flex justify-center w-full px-6">
                        <p className="text-base md:text-xl lg:text-2xl max-w-3xl leading-relaxed text-center opacity-80" style={{ color: theme.textMuted, margin: '1rem 0' }}>
                            {mounted ? t('process.subtitle') : "De la idea al lanzamiento: Un camino estructurado que garantiza resultados excepcionales."}
                        </p>
                    </div>
                </motion.div>
