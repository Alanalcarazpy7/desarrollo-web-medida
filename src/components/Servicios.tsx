    ...
    const servicios = [
        {
            ...
            descripcion: "Sitios web corporativos de alto rendimiento con diseño responsive y SEO optimizado.",
            icon: (
        ...
        },
        {
            numero: "02",
            titulo: "E-commerce",
            descripcion: "Tiendas online completas con carrito de compras, pasarelas de pago y panel administrativo.",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        },
        {
            ...
            descripcion: "Sistemas personalizados, dashboards interactivos y herramientas de gestión empresarial.",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        },
        {
            numero: "04",
            titulo: "Diseño UI/UX",
            descripcion: "Interfaces modernas e intuitivas diseñadas para maximizar conversiones y experiencia del usuario.",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        },
        {
            ...
            descripcion: "Optimización para motores de búsqueda y campañas de marketing digital con ROI medible.",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        },
        {
            ...
            descripcion: "Soporte técnico 24/7, actualizaciones de seguridad y monitoreo constante de rendimiento.",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            ...
            <div className="w-full max-w-7xl mx-auto px-6 md:px-8 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 px-4" style={{ margin: '1rem 0' }}>
                        <span style={{ color: theme.text }}>Soluciones </span>
