...
export default function Servicios() {
    ...
    const servicios = [
        {
            numero: "01",
            titulo: mounted ? t('services.items.web.title') : "Desarrollo Web SEO",
            descripcion: mounted ? t('services.items.web.desc') : "Sitios web corporativos de alto rendimiento, diseñados para posicionar en Google y convertir visitas en clientes.",
            href: "/servicios/desarrollo-web-paraguay",
            icon: (
        ...
        {
            numero: "02",
            titulo: mounted ? t('services.items.ecommerce.title') : "Tiendas Online (E-commerce)",
            descripcion: mounted ? t('services.items.ecommerce.desc') : "Plataformas de venta seguras y escalables. Catálogo autoadministrable y pasarelas de pago integradas.",
            href: "/#contacto",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        {
            numero: "03",
            titulo: mounted ? t('services.items.apps.title') : "Aplicaciones Web a Medida",
            descripcion: mounted ? t('services.items.apps.desc') : "Sistemas de gestión (ERP/CRM) personalizados para automatizar procesos y mejorar la productividad de tu empresa.",
            href: "/servicios/sistemas-informaticos-paraguay",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        {
            numero: "04",
            titulo: mounted ? t('services.items.design.title') : "Diseño UI/UX",
            descripcion: mounted ? t('services.items.design.desc') : "Interfaces modernas e intuitivas diseñadas para maximizar conversiones y experiencia del usuario.",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        {
            numero: "05",
            titulo: mounted ? t('services.items.seo.title') : "SEO & Marketing",
            descripcion: mounted ? t('services.items.seo.desc') : "Optimización para motores de búsqueda y campañas de marketing digital con ROI medible.",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        {
            numero: "06",
            titulo: mounted ? t('services.items.maintenance.title') : "Mantenimiento",
            descripcion: mounted ? t('services.items.maintenance.desc') : "Soporte técnico 24/7, actualizaciones de seguridad y monitoreo constante de rendimiento.",
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm font-bold uppercase tracking-[0.2em]" style={{ color: theme.accent }}>
                            {mounted ? t('services.badge') : "Servicios Premium"}
                        </span>
                    </motion.div>

                    {/* Título */}
                    <h2 className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 px-4" style={{ margin: '1rem 0' }}>
                        <span style={{ color: theme.text }}>{mounted ? t('services.titleStart') : "Soluciones"} </span>
                        ...
                        >
                            {mounted ? t('services.titleHighlight') : "Completas"}
                        </span>
                    </h2>
                    ...
                    >
                        <p className="text-base md:text-xl lg:text-2xl max-w-3xl leading-relaxed text-center opacity-80" style={{ color: theme.textMuted, margin: '1rem 0' }}>
                            {mounted ? t('services.subtitle') : "Todo lo que necesitas para llevar tu negocio al siguiente nivel digital"}
                        </p>
                    </motion.div>
                </motion.div>
